			...
			<div className='bg-white dark:bg-slate-800 h-[77.2vh] flex justify-center items-center flex-col relative'>
				<div className='w-11/12 my-9'>
					<button
						onClick={back}
						type='button'
						className='text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:outline-none focus:ring-cyan-300 shadow-lg shadow-cyan-500/50 dark:shadow-lg hover:duration-200 dark:shadow-cyan-800/80 font-medium rounded-lg text-lg px-7 py-2.5 text-center '
					>
						Back
					</button>
				</div>
				<div className='min-w-[300px] max-w-3xl w-11/12'>
					...
					<div className='flex justify-between w-full mb-9'>
						<button
							...
							onClick={() => {
								productDetail(dispatch, oneProduct.id)
								setEditModal(true)
							}}
						>
							Update
